...
public:		//get, set
	...
	//set함수
	void setBattle(bool isBattle) { _isBattle = isBattle; }
	...
	void setPlayerPoint(POINT p) { _pPoint = p; }
	...
	void setImage(image* img) { _player = img; }
	...
	void setBC(int battleCount) { _battleCount = battleCount; }	//battleScene의 _battleCount 받아옴
	void setPA(RECT *playerArea) { _playerArea =*playerArea; }	//battleScene의 _playerArea 받아옴
