...
public:
	...
	void scaleRender(HDC hdc, int destX, int destY, int x, float scale = 1.0f);
	void scaleRender(HDC hdc, int destX, int destY, int sourX, int sourY, int sourWidth, int sourHeight, float scale);
