...
//=============================================================
	...
	void render(string strKey, HDC hdc, int destX, int destY, int width, int height);
...
//=============================================================
	...
	void scaleRender(string strKey, HDC hdc, int destX, int destY, int x, float scale = 1.0f);
